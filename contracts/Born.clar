...
;; A brief, unique Clarity smart contract for RFPs in Google Clarity Web3
...
(define-map reveals ((id uint) (vendor principal)) ((proposal (string-utf8 48))))
...
;; Reveal proposal
(define-public (reveal (id uint) (proposal (string-utf8 48)) (salt (buff 32)))
